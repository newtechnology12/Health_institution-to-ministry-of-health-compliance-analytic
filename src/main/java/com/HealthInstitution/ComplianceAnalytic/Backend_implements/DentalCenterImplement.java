...
import com.HealthInstitution.ComplianceAnalytic.backend_services.DentalCenterServices;

import java.util.List;

public class DentalCenterImplement implements DentalCenterServices {
    @Override
    ...
    @Override
    public Caraes findByCountryName(String name) {
        return null;
    }
}
